function  [x_optimal cash_optimal] = strat_max_Sharpe(x_init, cash_init, mu, Q, cur_prices, r_rf, init_value)
...
%     captial = cur_prices(end,:) * x_init + cash_init;
