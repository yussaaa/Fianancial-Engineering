...
strategy_names     = {'Buy and Hold' 'Equally Weighted Portfolio' 'Mininum Variance Portfolio' 'Maximum Sharpe Ratio Portfolio' 'Mixed'};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
% for portfolio composition drawing-min_variance 
    if strategy == 3
    ...
    % for portfolio composition drawing-max_sharpe
    if strategy == 4
...
hold on; 
plot(portf_value{5}(:), 'g-', 'LineWidth', 1)
xlabel('Days');
ylabel('Portfolio Value');
title('Portfolio Value for each strategy')
legend('Location','southeast')
legend('Buy and Hold', 'Equally Weighted Portfolio', 'Mininum Variance Portfolio', 'Maximum Sharpe Ratio Portfolio','Mixed')  
